.class public final Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Companion;
...
.method public synthetic constructor <init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 60
    invoke-direct {p0}, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Companion;-><init>()V
...
# virtual methods
.method public final forVerifiedAccount(Lcom/ubnt/unifi/network/common/account/AccountManager$VerifiedAccount;)Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState;
    .locals 2

    const-string v0, "verifiedAccount"
    ...
    sget-object p1, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$None;->INSTANCE:Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$None;

    check-cast p1, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState;
    ...
    new-instance v0, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Account;
    ...
    invoke-direct {v0, p1}, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Account;-><init>(Lcom/ubnt/unifi/network/common/account/AccountManager$AccountInfo;)V
    ...
    new-instance v0, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Verifying;
    ...
    invoke-direct {v0, p1}, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Verifying;-><init>(Lcom/ubnt/unifi/network/common/account/AccountManager$AccountInfo;)V
    ...
    .line 68
    :cond_2
    new-instance v0, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Unverified;

    invoke-virtual {p1}, Lcom/ubnt/unifi/network/common/account/AccountManager$VerifiedAccount$UnverifiedAccount;->getAccountInfo()Lcom/ubnt/unifi/network/common/account/AccountManager$AccountInfo;

    move-result-object p1

    invoke-direct {v0, p1}, Lcom/ubnt/unifi/network/start/account/SSOAccountUI$AccountVisualState$Unverified;-><init>(Lcom/ubnt/unifi/network/common/account/AccountManager$AccountInfo;)V
