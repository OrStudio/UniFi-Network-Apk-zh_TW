.class final Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nDiscoverDeviceListViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 DiscoverDeviceListViewModel.kt\ncom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,85:1\n1#2:86\n*E\n"
.end annotation
...
# static fields
.field public static final INSTANCE:Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;

    invoke-direct {v0}, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;-><init>()V

    sput-object v0, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;->INSTANCE:Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;
...
.method public bridge synthetic apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$prepareDataStream$3;->apply(Lcom/ubnt/discovery/base/model/device/Device;)Lorg/reactivestreams/Publisher;
...
.method public final apply(Lcom/ubnt/discovery/base/model/device/Device;)Lorg/reactivestreams/Publisher;
    ...
    .line 74
    new-instance p1, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$DiscoveredDevice;

    move-object v3, p1

    invoke-direct/range {v3 .. v8}, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel$DiscoveredDevice;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/ubnt/unifi/network/start/controller/model/Device$Model;)V
    ...
    .line 76
    :cond_5
    const-class v0, Lcom/ubnt/unifi/network/start/device/discover/DiscoverDeviceListViewModel;

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "Failed to handle discovered device. name="
