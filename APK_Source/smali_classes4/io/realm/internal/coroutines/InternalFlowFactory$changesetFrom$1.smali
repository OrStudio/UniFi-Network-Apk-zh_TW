...
.method constructor <init>(Lio/realm/internal/coroutines/InternalFlowFactory;Lio/realm/RealmResults;Lio/realm/RealmConfiguration;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->this$0:Lio/realm/internal/coroutines/InternalFlowFactory;

    iput-object p2, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->$results:Lio/realm/RealmResults;

    iput-object p3, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->$config:Lio/realm/RealmConfiguration;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->this$0:Lio/realm/internal/coroutines/InternalFlowFactory;

    iget-object v2, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->$results:Lio/realm/RealmResults;

    iget-object v3, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->$config:Lio/realm/RealmConfiguration;

    invoke-direct {v0, v1, v2, v3, p2}, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;-><init>(Lio/realm/internal/coroutines/InternalFlowFactory;Lio/realm/RealmResults;Lio/realm/RealmConfiguration;Lkotlin/coroutines/Continuation;)V

    check-cast p1, Lkotlinx/coroutines/channels/ProducerScope;

    iput-object p1, v0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->p$:Lkotlinx/coroutines/channels/ProducerScope;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$2:Ljava/lang/Object;

    check-cast v0, Lio/realm/OrderedRealmCollectionChangeListener;

    iget-object v0, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$1:Ljava/lang/Object;

    check-cast v0, Lio/realm/Realm;

    iget-object v0, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$0:Ljava/lang/Object;
    ...
    iget-object p1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->p$:Lkotlinx/coroutines/channels/ProducerScope;
    ...
    iput-object p1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$0:Ljava/lang/Object;
    ...
    .line 173
    new-instance v3, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1$listener$1;

    invoke-direct {v3, p0, p1}, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1$listener$1;-><init>(Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;Lkotlinx/coroutines/channels/ProducerScope;)V

    check-cast v3, Lio/realm/OrderedRealmCollectionChangeListener;

    .line 183
    iget-object v4, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->$results:Lio/realm/RealmResults;

    invoke-virtual {v4, v3}, Lio/realm/RealmResults;->addChangeListener(Lio/realm/OrderedRealmCollectionChangeListener;)V

    .line 186
    iget-object v4, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->this$0:Lio/realm/internal/coroutines/InternalFlowFactory;
    ...
    .line 192
    :goto_1
    new-instance v4, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1$2;

    invoke-direct {v4, p0, v1, v3}, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1$2;-><init>(Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;Lio/realm/Realm;Lio/realm/OrderedRealmCollectionChangeListener;)V

    check-cast v4, Lkotlin/jvm/functions/Function0;

    iput-object p1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$0:Ljava/lang/Object;

    iput-object v1, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$1:Ljava/lang/Object;

    iput-object v3, p0, Lio/realm/internal/coroutines/InternalFlowFactory$changesetFrom$1;->L$2:Ljava/lang/Object;
